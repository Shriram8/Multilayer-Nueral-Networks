...
class NeuralNetwork(torch.nn.Module):
    ...
    def __init__(self, n_inputs, n_hiddens_per_layer, n_outputs, act_func='tanh', device='cpu'):
    ...
    def train(self, X, T, n_epochs, learning_rate, method='adam', verbose=True, standardize='X T'):
